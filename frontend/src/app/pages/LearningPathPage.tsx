              ...
              <div className="text-center">
                ...
                <div className="flex gap-4 mt-4">
                  <div className="w-24 h-24 bg-white rounded-lg flex items-center justify-center shadow">
                    <span className="text-sm text-neutral-600">Topic A</span>
                  </div>
                  <div className="w-24 h-24 bg-white rounded-lg flex items-center justify-center shadow">
                    <span className="text-sm text-neutral-600">Topic B</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        return (
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-6">
            <div className="flex gap-6">
              ...
              <div className="flex-1">
                <h4 className="font-semibold text-neutral-900 mb-3">Chapter 1: Introduction</h4>
      ...
      default: // summary
        return (
          <div className="bg-neutral-100 rounded-xl p-6">
            <h4 className="font-semibold text-neutral-900 mb-4">Key Points:</h4>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="w-6 h-6 bg-neutral-900 text-white rounded-full flex items-center justify-center text-sm flex-shrink-0 mt-0.5">1</span>
                <span className="text-gray-700">Understanding fundamental concepts and principles</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-6 h-6 bg-neutral-900 text-white rounded-full flex items-center justify-center text-sm flex-shrink-0 mt-0.5">2</span>
                <span className="text-gray-700">Practical applications and real-world examples</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-6 h-6 bg-neutral-900 text-white rounded-full flex items-center justify-center text-sm flex-shrink-0 mt-0.5">3</span>
        ...
        <div className="min-h-screen py-12 px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="surface-card p-8 mb-6">
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <p className="text-neutral-600">Topics you already understand well</p>
                </div>
              ...
              <div className="bg-green-50 rounded-xl p-6 mb-6">
                <h4 className="font-semibold text-neutral-900 mb-4">Summary:</h4>
                <ul className="space-y-2">
            ...
            {[2, 3, 4].map((moduleId) => {
              ...
              return (
                <div key={moduleId} className="surface-card p-8 mb-6">
                  <div className="flex items-start justify-between mb-6">
                    <div>
                      <h2 className="text-2xl font-semibold text-neutral-900 mb-2">
                        Module {moduleId}: Learning Area {moduleId - 1}
                      </h2>
                      <p className="text-neutral-600">Topics to strengthen your understanding</p>
                    </div>
                    <span className="inline-flex items-center px-3 py-1 bg-neutral-200 text-neutral-800 rounded-lg text-sm font-medium">
                      Learning
                    </span>
                  </div>
            ...
            <div className="text-center mt-8">
              <button
                ...
                className="px-12 py-4 bg-neutral-900 text-white rounded-xl font-medium hover:bg-neutral-800 transition-all shadow-lg hover:shadow-xl"
              >
